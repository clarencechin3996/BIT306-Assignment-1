...
export class AccService{ //Create a account class
  ...
  AddRequest(description: string,datetime: Date, studentlevel: string, numofexpectedstudents: string, status: string, school_name: string, city: string, resourcedescription: string, resourcetype: string, resourcenum: string, requestID: string, requesttype: string){ // method to add account with arguments
    const request: Request = {description: description, datetime: datetime, studentlevel: studentlevel, numofexpectedstudents: numofexpectedstudents, status: status, school_name: school_name, city: city, resourcedescription:resourcedescription, resourcetype:resourcetype, resourcenum:resourcenum, requestID: requestID, requesttype:requesttype }; // variable storing values of account
